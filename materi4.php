<?php
    ...
    if (isset($_POST['kirim'])){
        ...
        $sql = "INSERT INTO pengguna (username, password, email, nama) VALUES ('$username', '$password', '$email', '$nama')";
...
<?php
    ...
    if (isset($_POST['simpan'])) {
        ...
        $sql = "UPDATE pengguna SET username = '$username', password = '$password', email = '$email', nama = '$nama' WHERE id = $id";
        $query = mysqli_query($conn, $sql);
        if ($query) {
